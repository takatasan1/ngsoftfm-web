...
public:
     ...
     * bandwidth  :: bandwidth relative to sample frequency
        * minsignal_on  :: minimum pilot amplitude to declare lock
        * minsignal_off :: pilot amplitude threshold below which lock is lost
     */
        PilotPhaseLock(double freq, double bandwidth, double minsignal_on, double minsignal_off);
...
private:
    ...
    Sample  m_minsignal_on;
    Sample  m_minsignal_off;
...
public:
     ...
     */
        FmDecoder(double sample_rate_if,
                  ...
                  bool   stereo=true,
                  double deemphasis=default_deemphasis,
...
private:
    ...
    const bool      m_force_stereo_output;
